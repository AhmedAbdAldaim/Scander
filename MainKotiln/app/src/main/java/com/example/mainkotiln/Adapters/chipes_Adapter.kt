...
class chipes_Adapter : RecyclerView.Adapter<chipes_Adapter.ViewHolder>(){
    var Countr = 0
     ...
     private val name_product = arrayOf(
         "دوريتويس"," دوريتويس ", "دوريتويس", "دوريتويس", "دوريتويس", "دوريتويس"
     )
     private val price = arrayOf(
         "150 ج.س ", "150 ج.س ", "150 ج.س", "150 ج.س","150 ج.س", "150 ج.س"
     )
     ...
     override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
      ...
      val v = LayoutInflater.from(parent.context).inflate(R.layout.custom_chipes,parent,false)
         return ViewHolder(v)
     }
